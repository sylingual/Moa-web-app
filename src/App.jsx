...
const T = {
  fr: {
    ...
    moreExamples: "Plus d'exemples", onlineRes: "Ressources complémentaires", realExamples: "Exemples authentiques", searching: "Recherche en cours...", sources: "Sources",
  ...
  en: {
    ...
    moreExamples: "More examples", onlineRes: "Further resources", realExamples: "Real examples", searching: "Searching...", sources: "Sources",
...
2. The ${L} translation on the next line
...
1. A GRAMMAR RECAP for the student: a short, clear reference card they can re-read later. Write it in ${L}. Include:
   ...
   - 2-3 key example sentences from the lesson (in the target language + ${L} translation)
                  ...
                  {lessonSummary && (
                    <div style={{ background: C.s2, border: `1px solid ${(lessonSummary.error || lessonSummary.structuresLearned === "Error generating summary") ? C.warnB : C.okB}`, borderRadius: 10, padding: 16, margin: "4px 0" }}>
                      ...
                      {(lessonSummary.error || lessonSummary.structuresLearned === "Error generating summary") ? (
                        ...
                        <>
                          <div style={{ fontSize: 12.5, color: C.txt, lineHeight: 1.8, whiteSpace: "pre-wrap" }}>
                            {lessonSummary.grammarRecap || lessonSummary.structuresLearned}
                          </div>
